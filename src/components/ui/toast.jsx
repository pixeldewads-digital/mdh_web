...
const toastVariants = cva( 
 ...
 'data-[swipe=move]:transition-none group relative pointer-events-auto flex 

w-full items-center justify-between space-x-4 overflow-hidden rounded-md 
   ...
   variants: { 
     ...
     variant: { 
       ...
       destructive: 
         ...
         'group destructive border-destructive bg-destructive 
...
disabled:opacity-50 group-[.destructive]:border-destructive/30 
